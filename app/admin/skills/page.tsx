      ...
      <main className='admin-main'>
        ...
        {showCatForm && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100 }}>
            <div style={{ background: '#111118', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '32px', width: '400px' }}>
            ...
            <div style={{ background: '#111118', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '16px', padding: '32px', width: '400px' }}>
              ...
              <div style={{ display: 'grid', gap: '14px' }}>
                ...
                <div>
                  ...
                  <input type="range" min={0} max={100} value={skillForm.percentage} onChange={e => setSkillForm((p: any) => ({ ...p, percentage: Number(e.target.value) }))}
                    style={{ width: '100%' }} />
                </div>
                <div>
