    ...
    <div style={{ background: '#0a0a0f', minHeight: '100vh', color: 'white', paddingTop: '100px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px 80px' }}>
        <div style={{ marginBottom: '48px' }}>
          ...
          <h1 style={{ fontSize: 'clamp(32px, 6vw, 48px)', fontWeight: 800, margin: '0 0 16px' }}>Artikel & Tulisan</h1>
              ...
              <div style={{ padding: '20px' }}>
                <div style={{ display: 'flex', gap: '8px', marginBottom: '10px', flexWrap: 'wrap' }}>
                  ...
                  {item.tags?.slice(0, 2).map((tag: string) => (
                    <span key={tag} style={{ background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.4)', fontSize: '11px', padding: '3px 10px', borderRadius: '999px' }}>{tag}</span>
                  ))}
                </div>
