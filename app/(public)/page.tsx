...
export default function HomePage() {
  ...
  return (
    <div style={{ background: '#0a0a0f', minHeight: '100vh', color: 'white' }}>
      ...
      {/* HERO */}
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden', background: 'radial-gradient(ellipse at 70% 50%, rgba(99,102,241,0.08) 0%, transparent 60%), radial-gradient(ellipse at 30% 80%, rgba(168,85,247,0.06) 0%, transparent 60%)' }}>
        <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', padding: '120px 64px 80px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>

            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '999px', padding: '6px 16px', width: 'fit-content' }}>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                ...
                <Link href="/about" style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: 'white', padding: '12px 24px', borderRadius: '999px', fontSize: '14px', fontWeight: 500, textDecoration: 'none' }}>
                  Resume
                </Link>
              </div>
            </div>
      ...
      <section style={{ padding: '64px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '24px' }}>
          {[
            ...
            <div key={stat.label} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px', textAlign: 'center' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '16px', marginBottom: '16px' }}>
            <div className="card">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                <div style={{ width: '32px', height: '32px', background: 'rgba(99,102,241,0.2)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>📄</div>
                <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '13px' }}>Research Highlights</span>
              </div>
              <h3 style={{ fontSize: '18px', fontWeight: 600, color: 'white', marginBottom: '12px' }}>Penelitian Bahasa Arab & Pendidikan Islam</h3>
              <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '13px', lineHeight: 1.7, marginBottom: '24px' }}>Berfokus pada optimasi media pembelajaran bahasa Arab dan inovasi teknologi dalam pendidikan Islam modern.</p>
            ...
            <div className="card">
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
                <div style={{ width: '32px', height: '32px', background: 'rgba(168,85,247,0.2)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>⚡</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '16px' }}>
            <div className="card">
              ...
              <h4 style={{ color: 'white', fontWeight: 600, fontSize: '13px', lineHeight: 1.6, marginBottom: '8px' }}>Media Pembelajaran Bahasa Arab Berbasis AI</h4>
            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '20px' }}>
                {[
                  ...
                  <div key={item.title} style={{ display: 'flex', gap: '12px', padding: '14px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', alignItems: 'flex-start' }}>
      ...
      <section style={{ padding: '0 64px 80px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ background: 'linear-gradient(135deg, rgba(49,46,129,0.6), rgba(88,28,135,0.4))', border: '1px solid rgba(99,102,241,0.2)', borderRadius: '24px', padding: '80px', textAlign: 'center' }}>
            <h2 style={{ fontSize: '40px', fontWeight: 700, color: 'white', marginBottom: '16px' }}>Tertarik Berkolaborasi?</h2>
            <p style={{ color: 'rgba(255,255,255,0.5)', marginBottom: '32px', lineHeight: 1.7, maxWidth: '480px', margin: '0 auto 32px' }}>
